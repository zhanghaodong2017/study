...
public class DuanNioSocketClient extends Thread {
    private SocketChannel socketChannel;
    private Selector selector = null;
    private int clientId;

    public DuanNioSocketClient() {
    }

    public DuanNioSocketClient(int clientId) {
        this.clientId = clientId;
    }

    public static void main(String args[]) throws IOException {
        DuanNioSocketClient client = new DuanNioSocketClient();
        client.initClient();
        client.start();
    }
