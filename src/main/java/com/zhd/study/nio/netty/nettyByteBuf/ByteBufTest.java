package com.zhd.study.nio.netty.nettyByteBuf;
...
//        simpleUse();
    ...
    private static void createByteBuf() {
        ...
        System.out.println("pool-byteBuf：" + byteBuf.toString());
    ...
    private static void simpleUse() {
        ...
        ByteBuf buf2 = buf.readBytes(bytes4);
        System.out.println("读取的bytes为====================>" + Arrays.toString(bytes4));
        System.out.println("原来的ByteBuf为===========>" + buf.toString());
        System.out.println("读取后的ByteBuf为===========>" + buf2.toString());
        System.out.println("9.ByteBuf中的内容为===============>" + Arrays.toString(buf.array()) + "\n");
    }
}
