...
<div id="content" style="margin-top: 2em;">
    <div class="container-fluid">
        <form th:action="@{/${tableEntityName}/update}" method="POST" id="${tableEntityName}Form">
                ...
                <table style="width: 800px">
                    <#list columnMap?keys as key >
                     <tr>
                        ...
                        <td width="70%">
                        <input class="form-control" id="${key}" maxlength="60" name="${tableEntityName}.${key}" th:value="${r'${'}${tableEntityName}.${key}${r'}'}" />
                        </td>
                     </tr>
                    </#list>
